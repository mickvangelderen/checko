...
describe('areDeepEqual', () => {
	it('should export a function', () => {
		expectFunction(expectDeepEqual)
	})

  function p(value, key) { expectSame(expectDeepEqual(value, key), value) }
  function n(value, key) { expectToThrow(expectDeepEqual, null, [ value, key ]) }
